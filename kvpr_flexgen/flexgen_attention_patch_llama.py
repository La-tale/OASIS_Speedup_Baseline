...
def _flexgen_llama_attention_forward(self, hidden_states, attention_mask=None, position_ids=None, past_key_value=None,
...
def _flexgen_llama_flash_attention_forward(
    self,
...
def _flexgen_llama_sdpa_attention_forward(
    self,
    hidden_states: torch.Tensor,
    ...
    **kwargs,
    ...
    if output_attentions:
        return _flexgen_llama_attention_forward(
            self,
...
def apply_flexgen_llama_attention_patch():
    ...
    modeling_llama.LlamaAttention.forward = _flexgen_llama_attention_forward
    ...
    modeling_llama.LlamaFlashAttention2.forward = _flexgen_llama_flash_attention_forward
    ...
    modeling_llama.LlamaSdpaAttention.forward = _flexgen_llama_sdpa_attention_forward


def undo_flexgen_llama_attention_patch():
    global _ORIG_LLAMA_ATTENTION_FORWARD, _ORIG_LLAMA_FLASH_ATTENTION_FORWARD, _ORIG_LLAMA_SDPA_ATTENTION_FORWARD
